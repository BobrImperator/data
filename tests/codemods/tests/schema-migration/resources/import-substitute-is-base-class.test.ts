...
describe('importSubstitutes pointing to intermediateModelPaths base class', function () {
  test('substitute trait and extension are not applied when the substitute is also an intermediate model path', {
    config: {
